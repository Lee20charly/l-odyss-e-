...
const topDishes = [
  {
    id: "top1",
    name: "viande de brouse au nwebwe",
    description: "Notre plat de viande de brouse aux noix de palme",
  ...
  {
    id: "top2",
    name: "paquet de poisson",
    description: "paquet de poisson traditionnel ",
  ...
  {
    id: "top3",
    name: "sanglier aux aubergines",
    description: "sanglier aux aubergines savoureux aux épices locales",
    image: "/sanglier auc aubergines.svg",
    price: 10000,
    rating: 4.7,
    reviews: 84,
  },
